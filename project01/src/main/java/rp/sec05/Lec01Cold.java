...
public class Lec01Cold {

    public static void main(String[] args) throws InterruptedException {

        // From one channel i send to chaque subseiber his personal  data

        Flux<String> flux = Flux.fromStream(() -> getDataStream()).delayElements(Duration.ofSeconds(1));
